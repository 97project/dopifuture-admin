                ...
                <tr>
                    ...
                    <td>
                        <div style="display:flex;gap:6px;align-items:center;">
                            <button class="dp-action dp-action-edit" style="background:none;border:none;cursor:pointer;color:var(--color-txt-muted);padding:4px;display:flex;align-items:center;gap:4px;font-size:12px;">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                {{ $isTr ? 'Düzenle' : 'Edit' }}
                            </button>
                            <button class="dp-action dp-action-view" style="background:none;border:none;cursor:pointer;color:var(--color-primary);padding:4px;display:flex;align-items:center;gap:4px;font-size:12px;">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                                {{ $isTr ? 'Şifre Sıfırla' : 'Reset Password' }}
                            </button>
                            <button class="dp-action" style="background:none;border:none;cursor:pointer;color:var(--color-error-red);padding:4px;display:flex;align-items:center;gap:4px;font-size:12px;">
