            ...
            <div class="hierarchy-students">
                ...
                <div style="padding:6px 20px 6px 52px;display:flex;align-items:center;justify-content:space-between;font-size:13px;border-top:1px solid var(--color-row-border,#f0f0f0);">
                    <div style="display:flex;align-items:center;gap:6px;">
                        <span style="width:22px;height:22px;border-radius:50%;background:#E8F0FE;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700;color:#0B6AB2;">{{ mb_strtoupper(mb_substr($s->name ?? 'S', 0, 1)) }}</span>
